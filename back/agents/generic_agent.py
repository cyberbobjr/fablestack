...
class GenericAgent:
    ...
    **Description:** A generic PydanticAI agent for simple generation tasks without session context.
    ...
    def __init__(self, llm_config: LLMConfig, system_prompt: str = "", output_type: Any = str) -> None:
        """
        ### __init__
        ...
        **Parameters:**
        ...
        - `output_type` (Any): The type of the output to be generated by the agent. Defaults to str.
        """
...
def build_simple_gm_agent(output_type: Any = str) -> Agent:
    """
...
Always respond concisely and appropriately to the provided context."""
    ...
    return GenericAgent(llm_config, system_prompt, output_type=output_type).agent
